...
def btn_clicked(whereto,budget,days,travelers):
    ...
    packageMaker(window,whereto_contents,budget_contents,days_contents,travelers_contents)
    # thread = thread(target=packageMaker, args=(window,whereto_contents,budget_contents,days_contents,travelers_contents))
    # thread.start()
window = Tk()
